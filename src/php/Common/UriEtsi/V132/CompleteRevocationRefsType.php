...
class CompleteRevocationRefsType
{
    ...
    /**
     * @var \UBL21\Common\UriEtsi\V132\CRLRefType[] $cRLRefs
     */
    private $cRLRefs = null;

    /**
     * @var \UBL21\Common\UriEtsi\V132\OCSPRefType[] $oCSPRefs
     */
    private $oCSPRefs = null;

    /**
     * @var \UBL21\Common\UriEtsi\V132\AnyType[] $otherRefs
     */
     ...
     */
    public function addToCRLRefs(\UBL21\Common\UriEtsi\V132\CRLRefType $cRLRef)
    {
        $this->cRLRefs[] = $cRLRef;
        return $this;
    }
     ...
     * Sets a new cRLRefs
     *
     * @param \UBL21\Common\UriEtsi\V132\CRLRefType[] $cRLRefs
     * @return self
     */
     ...
     */
    public function addToOCSPRefs(\UBL21\Common\UriEtsi\V132\OCSPRefType $oCSPRef)
    {
     ...
     * Sets a new oCSPRefs
     *
     * @param \UBL21\Common\UriEtsi\V132\OCSPRefType[] $oCSPRefs
     * @return self
     */
     ...
     */
    public function addToOtherRefs(\UBL21\Common\UriEtsi\V132\AnyType $otherRef)
    {
     ...
     *
     * @param \UBL21\Common\UriEtsi\V132\AnyType[] $otherRefs
     * @return self
     */
